...
while ans == 1:
    ...
    while True:
        price = ans2 = 0
        name = ""
        name = str(input("Enter the product name: US$"))
        while name == "":
        ...
        if ans2 != 1:
            break
    if contproduct == 1:
        print(f"{colors['yellow']}You just enter one product so the total price is US${sum}{colors['clean']}")
        if contprice == 1:
        ...
        print(f"{colors['yellow']}You enter {contproduct} products and the total price is US${sum}{colors['clean']}")
        if contprice == 1:
        ...
        print(f"{colors['yellow']}The produt more cheap is {cheapname} and the price is US${cheaprice}{colors['clean']}")
